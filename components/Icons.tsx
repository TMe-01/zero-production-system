...
// Category Icons
export const PersonalIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
...
export const WorkIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 14.15v4.07a2.25 2.25 0 01-2.25 2.25h-13.5a2.25 2.25 0 01-2.25-2.25v-4.07m18-4.22l-7.5-4.22m0 0l-7.5 4.22m7.5-4.22v1.512a2.25 2.25 0 001.529 2.128l4.5 2.121m-9-4.242v1.512a2.25 2.25 0 01-1.529 2.128l-4.5 2.121" />
  </svg>
);
export const LearningIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path d="M12 14l9-5-9-5-9 5 9 5z" />
    <path d="M12 14l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 14l9-5-9-5-9 5 9 5zm0 0v5.5a2.5 2.5 0 002.5 2.5h1.5a2.5 2.5 0 002.5-2.5V14m-6.5 0v5.5a2.5 2.5 0 01-2.5 2.5H6a2.5 2.5 0 01-2.5-2.5V14" />
  </svg>
);
export const StudyingIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
...
export const EntertainmentIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    ...
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 5.25v2.25m0 0H7.541M12 7.5h4.459M12 7.5a2.25 2.25 0 012.25 2.25 2.25 2.25 0 01-2.25 2.25 2.25 2.25 0 01-2.25-2.25 2.25 2.25 0 012.25-2.25z" />
  </svg>
);
...
export const MentalIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    ...
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9.004 9.004 0 008.25-6.108m-16.5 6.108a9.004 9.004 0 018.25-6.108m0 0H12m0 0c-1.147 0-2.278-.15-3.388-.435m3.388-.435a15.998 15.998 0 005.043-3.025m-5.043 3.025a15.998 15.998 0 01-3.388-1.62m0 0a2.25 2.25 0 012.4-2.245 3 3 0 005.78 1.128 2.25 2.25 0 012.4 2.245 4.5 4.5 0 00-8.4-2.245c0-.399.078-.78.22-1.128zm0 0a15.998 15.998 0 01-3.388-1.62" />
  </svg>
);
...
export const LightbulbIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 001.5-.184m-1.5.184a6.01 6.01 0 01-1.5-.184m3.75 7.484V18a2.25 2.25 0 01-4.5 0v-2.25m3.75 2.25a2.25 2.25 0 004.5 0v-2.25m-3.75 2.25a2.25 2.25 0 01-4.5 0v-2.25m0 0V5.625c0-1.036.84-1.875 1.875-1.875h.375c1.036 0 1.875.84 1.875 1.875v7.5m-5.625 0v7.5m-3.75-7.5V5.625c0-1.036.84-1.875 1.875-1.875h.375c1.036 0 1.875.84 1.875 1.875v7.5m0 0v-7.5" />
    </svg>
);
